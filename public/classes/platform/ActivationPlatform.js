...
class ActivationPlatform extends Platform {
    ...
    get triggerZoneX() { return this.#triggerZoneX; }
    set triggerZoneX(value) { this.#triggerZoneX = value; }
    get activationTimer() { return this.#activationTimer; }
    set activationTimer(value) { this.#activationTimer = value; }
    get isActivated() { return this.#isActivated; }
    set isActivated(value) { this.#isActivated = value; }
    get triggerZoneY() { return this.#triggerZoneY; }
    set triggerZoneY(value) { this.#triggerZoneY = value; }
    get tmpActivationTimer() { return this.#tmpActivationTimer; }
    set tmpActivationTimer(value) { this.#tmpActivationTimer = value; }
