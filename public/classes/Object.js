...
class Object extends GameObject{
    ...
    get spriteSheetOffsetX() { return this.#spriteSheetOffsetX; }
    set spriteSheetOffsetX(value) { this.#spriteSheetOffsetX = value; }

    get spriteSheetOffsetY() { return this.#spriteSheetOffsetY; }
    set spriteSheetOffsetY(value) { this.#spriteSheetOffsetY = value; }
